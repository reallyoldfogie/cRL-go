...
// TestResumeFromCheckpointDirPicksLatestAcrossMultipleSaves confirms
// resuming after several periodic saves picks up the most recent one
// (highest epoch), not an earlier one.
